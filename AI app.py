# AI app.py — FINAL VERSION with columns layout
...
# Helper: convert appointment time string to number
...
if st.button("Predict Availability"):
    ...
    log_entry = {
        ...
        'availability': (
            "Available" if predicted_prob < 0.3 else
            "Medium Risk" if predicted_prob < 0.6 else
            "Not Available"
        )
    }
